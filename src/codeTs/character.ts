...
export class Character extends NotchSprite {
    // Static in Notch's code... here it doesn't seem necessary
    Large: boolean = false;
    Fire: boolean = false;
    Coins: number = 0;
    Lives: number = 3;
    LevelString: string = "none";
    GroundInertia: number = 0.89;
    AirInertia: number = 0.89;
    ...
    LastLarge: boolean = false;
    LastFire: boolean = false;
    NewLarge: boolean = false;
    NewFire: boolean = false;
